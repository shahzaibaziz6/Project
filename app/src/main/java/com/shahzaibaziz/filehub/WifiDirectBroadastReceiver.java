...
public class WifiDirectBroadastReceiver extends BroadcastReceiver {
    static final int MESSAGE_READ=1;
    private WifiP2pManager mManager;
    private WifiP2pManager.Channel mChannel;
    private SendActivity mActivity;
    public WifiDirectBroadastReceiver(WifiP2pManager m, WifiP2pManager.Channel c, SendActivity main)
    {
        mManager=m;
        mChannel =c;
        mActivity= main;
